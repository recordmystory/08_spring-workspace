...
<body>
	...
	// 아이디와 비밀번호로 검색1 클릭 시 실행될 function
		...
		/*
			회원 전체 조회 버튼 클릭시 searchList 함수 호출하도록 하고
				function searchList(){
					//ajax로 "/member1/list.do" url 요청 후 결과값 받아오기
					
					// controller에서는 전체조회용 서비스 호출하여 돌려받은 List를 응답데이터로 돌려주기
					
					// console.log로 돌아온 응답데이터 확인 후 table 요소로 조회된 회원데이터 #result로 뿌리기
		}
		*/
